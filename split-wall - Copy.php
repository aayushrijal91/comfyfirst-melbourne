...
$title = 'Free Estimates On New Split System AC';
							...
							<div class="card-body p-xxl-5 p-4">
								<div class="row">
									<div class="col-xxl-12">
										<p class=" text-dark display-2 line-height-1 fw-bold">Free Estimates On New Split System AC With <?= $global_city ?>'s Cooling Experts</p>
									</div>
								</div>
								<p class="h3">Save on AC Cooling Specialists Licensed Technicians</p>
								<p>For the best in new split system air conditioning for your <?= $global_city ?> home, you can depend of the experienced home cooling experts at ComfyFirst. Read testimonials from other ComfyFirst customers here and about our satisfaction guaranteed service here.</p>
							</div>
						</div>
				...
				<div class="row align-items-center">
					...
					<div class="col-xxl-7">
						<div class="py-3 py-xxl-5">
							<p class="display-2 fw-bold line-height-1 mb-xxl-5 mb-4">Free Estimates On New Split System AC</p>
		...
		<div class="row justify-content-center">
			<div class="col-xxl-9">
				<div class="row align-items-center">
					<div class="col-xxl-6">
						<div class="py-3 py-xxl-5">
							<p class="display-2 fw-bold line-height-1 mb-4 me-xxl-n5">Expert Advice On New Split Air Conditioning Systems</p>
							...
							<p>We'll help you choose the best split system to suit your needs. From energy efficiency ratings to choosing the right capacity to effectively cool the required room or space, to choosing a model with the preferred operational features. </p>

							<p>We also provide expert advice on how to get the most efficiency out of your chosen system, talk you through it's operational manual and features to ensure you take full advantage and benefit from your new AC system.</p>
						</div>
					</div>
