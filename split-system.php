...
$banner = 'Split System<br>Air Conditioning';
							...
							<div class="card-body p-xxl-5 p-4">
								<div class="row">
									<div class="col-xxl-12">
										<p class=" text-dark display-2 line-height-1 fw-bold">What is a <?= $global_city ?> Split System?</p>
									</div>
								</div>
								<p>A split system air conditioner can provide an excellent cooling and heating solution for your home. There are, a variety of options available, ranging from small split system air conditioners to extensive ducted ones. All major brands offer a variety of models, so you're sure to find one that meets your needs. The various types of split units include the following:</p>
								<ul>
									<li>Split units for single rooms</li>
									<li>Split units with multiple heads</li>
									<li>Split units mounted on the wall</li>
									<li>Cassette units concealed in the ceiling</li>
								</ul>
								<p>You may choose any of the above for your residence or business.</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row align-items-center">
					...
					<div class="col-xxl-7">
						<div class="py-3 py-xxl-5">
							<p class="display-2 fw-bold line-height-1  mb-4">The Best Air Conditioning & Heating Solutions</p>
							<hr class="hr-h hr-white ">
							<p>Split system air conditioners with no ducts are quite widely used in Australia. These units can be found in a variety of locations, including office buildings, residences, spas, and eateries. They are both energy efficient and adaptable, fitting into virtually any space.</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row justify-content-center">
			<div class="col-xxl-9">
				<div class="row align-items-center">
					<div class="col-xxl-6">
						<div class="py-3 py-xxl-5">
							<p class="display-2 fw-bold line-height-1 mb-4 me-xxl-n5">The Advantages of a Split System</p>
							...
							?>
							<p>There are many advantages to utilising a split system, including the following:</p>
							<ul>
								<li>Simple to install and maintain.</li>
								<li>High cooling capacity is ideal for cooling extremely large rooms.</li>
								<li>Because they are wall mounted, they take up no floor space.</li>
								<li>While cooling and heating, the unit operates quietly.</li>
								<li>Elegant and stylish in appearance</li>
								<li>Cost-effective pricing and operation</li>
								<li>Economical in terms of energy</li>
								<li>Reduces allergens, thereby improving the air quality in your home</li>
								<li>Eco-friendly</li>
							</ul>
