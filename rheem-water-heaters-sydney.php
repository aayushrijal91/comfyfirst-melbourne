...
$title = 'Rheem Hot Water System Heater ' . $global_city . ' | Rheem Water Heater Plumber';
...
$banner = $global_city . " Rheem Water Heater Plumbers";
	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-xxl-9">
				...
				<div class="card mb-4 mb-xxl-5 shadow border-0 rounded-0">
					<div class="row g-0">
						<div class="col-xl-4 order-2 order-xl-1">
							<?= lazyImg("$imgfolder/cc5.jpg", randalts($alts), "br w-100 h-100") ?>
						</div>
						<div class="col-xl-8 order-1 order-xl-2">
							<div class="card-body p-xxl-5 p-4">
								<p class=" text-dark display-2 line-height-1 fw-bold"><?= $global_city ?> Rheem Water Heater Plumbers</p>
								<p>Rheem Water Heater specialists at PlumbFirst can bring hot water to your <?= $global_city ?> home Today. Licensed PlumbFirst plumbers will install your new Rheem water heater professionally and in time.</p>
							</div>
						</div>
				...
				<div class="row">
					<?php $bctas = [
						'RHEEM HOT WATER SPECIALISTS IN ' . $global_city . ': SAME DAY REPAIRS' => "When it comes to fast, same day Rheem water heater repairs, you can rely on PlumbFirst experts. We operate from multiple locations around the metropolitan area which enables us to provide you with fast service.",
						'ON-TIME RHEEM WATER HEATER REPAIRS OR WE PAY YOU!*' => "We at the PlumbFirst highly value your time, so We will pay You up to $110 if we are late to fix your Rheem Water Heater.",
						'THE BEST IN BRAND NEW RHEEM WATER HEATERS' => "Choose amongst the wide variety of Rheem water heaters on market. Our PlumbFirst plumbers will offer you a free estimate on new system installation, along with a quote for the job in advance.",
						'CHOOSING THE RIGHT RHEEM WATER HEATER' => "Our skilled plumbers will answer any question you might have and help you save by choosing the apropriate Rheem water heater system for your home.",
						'HOT WATER EXPERTS' => "PlumFirst plumbers have installed and repaired thousands of Rheem water heaters every year, so you can have a peace of mind knowing that you are receiving only the best service in " . $global_city . ".",
						'UP FRONT PRICING' => "We will provide you with an up-front price for the installation or the repair of Rheem water heater system.",
						'SATISFACTION GUARANTEED SERVICE' => "Discover the PlumbFirst difference for yourself, or read from our other happy customers here.",
					];
					$i = 0;
				...
				<p class="h4 text-dark mt-3">For same day Rheem water heater repairs or new Rheem water heater installation call Today <?= $global_city ?>'s Rheem specialists at PlumbFirst.</p>
			</div>
		</div>
	</div>
</section>
