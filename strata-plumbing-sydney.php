...
$title = 'Strata Plumbing ' . $global_city . ' | Trusted Strata Plumber';
$description = "If you're looking for a professional Strata Plumber in " . $global_city . ", call and speak with PlumbFirst today for great deal & service for your strata property. ";
$imgfolder = 'gas';

$banner = "The Trusted Strata Plumbing Professionals";
	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-xxl-9">
				...
				<div class="card mb-4 mb-xxl-5 shadow border-0 rounded-0">
					<div class="row g-0">
						<div class="col-xl-4 order-2 order-xl-1">
							<?= lazyImg("$imgfolder/cc35.jpg", randalts($alts), "br w-100 h-100") ?>
						</div>
						<div class="col-xl-8 order-1 order-xl-2">
							<div class="card-body p-xxl-5 p-4">
								<p class=" text-dark display-2 line-height-1 fw-bold">The Trusted Strata Plumbing Professionals in <?= $global_city ?></p>
								<p>If you're a strata, property or facilities manager in <?= $global_city ?> looking for reliable and professional plumbing, then you can count on the great service you'll receive from PlumbFirst. </p>
							</div>
						</div>
				...
				<p class="h1 line-height-1 text-dark text-center fw-bold mb-5 mt-xxl-5">Discover how PlumbFirst can help you today.</p>

				<div class="row">
					<?php $bctas = [
						'RELIABLE PLUMBERS' => "Property and strata managers need plumbing contractors they can count on to get the job done without the need for micro-managing. We'll be there on-time, provide a full report, and save you time and money on looking after your clients' plumbing maintenance.",
						'ALL PLUMBING NEEDS' => "Experts with all your commercial plumbing and residential plumbing needs, with a full range of services.",
						'PROFESSIONAL' => "All of our plumbers are fully licensed and insured.",
						'COVERAGE ACROSS ' . $global_city . ' FROM MULTIPLE LOCATIONS' => "For faster service, PlumbFirst has coverage right across the metropolitan area from multiple locations, making it even easier for managers with multiple properties to rely on one plumbing company that can service all of their portfolio.",
						'SMART PLUMBERS' => "Our plumbers are courteous, smart and professional, and will take care of the resident or end client's needs.",
						'24 HOURS, 7 DAYS' => "With plumbing teams on standby for all your plumbing emergencies around the clock.",
					];
					$i = 0;
							...
							<div class="card rounded-0 border-0 h-100">
								...
								<div class="card-body h-100">
									<div class="row mb-3 align-items-center">
										...
										<div class="col">
											<p class="mb-0 h4 line-height-1 fw-bold text-dark"><i><?= $key ?></i></p>
										</div>
									</div>
				...
				<p class="h4 text-dark mt-3">For great service for all your strata or property-managed plumbing needs across <?= $global_city ?>, call and speak with PlumbFirst today.</p>
