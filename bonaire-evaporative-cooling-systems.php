...
$title = 'Bonaire Evaporative Cooling Experts';
...
$banner = 'Bonaire Evaporative Cooling Experts';
							...
							<div class="card-body p-xxl-5 p-4">
								<div class="row">
									<div class="col-xxl-12">
										<p class=" text-dark display-2 line-height-1 fw-bold">Bonaire Evaporative Cooling Experts in <?= $global_city ?></p>
									</div>
								</div>
								<p>For an economic solution to cooling your <?= $global_city ?> home, consider the benefits of a Bonaire evaporating cooling system and speak with the friendly cooling system experts at ComfyFirst. Read reviews from customers we've delighted here.</p>
							</div>
						</div>
				...
				<div class="row align-items-center">
					...
					<div class="col-xxl-7">
						<div class="py-3 py-xxl-5">
							<p class="display-2 fw-bold line-height-1 mb-xxl-5 mb-4">Free Estimates On New Bonaire Evaporative Cooling Systems!</p>
							<hr class="hr-h hr-white mb-xxl-5">
							<p class="">Discover how affordable a new Bonaire evaporative cooler is with our FREE ESTIMATES on new installations.</p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row align-items-center">
					<div class="col-xxl-6">
						<div class="py-3 py-xxl-5">
							...
							<p>We'll professionally install your new Bonaire evaporative cooling system and provide advice and guidance on operating features.</p>
		...
		<div class="row justify-content-center">
			<div class="col-xl-9">
				<div class="row">
					<?php
					$contents = [
						'Environmental And Economical Cooling Solution' => "Bonaire Evaporative cooling uses less energy to cool compared to other systems as it extracts air from outside to cool rather than cooling hot air from within your home and recirculating it. It also emits less carbon dioxide and no CFC or HFC gases which are harmful to the ozone layer.",
						'An Alternative Cooling Choice For Allergy Sufferers' => "Bonaire evaporative coolers offer an alternative to cooling your home when members of your household suffer from breathing ailments or allergies as it uses fresh air from outside rather than recirculating air already within the home.",
						'Excellent Warranties' => 'Enjoy excellent warranties on your new Bonaire evaporative cooler, plus our workmanship is backed by a warranty for your added peace of mind.<br>For expert advice and professional installation of Bonaire evaporative cooling systems in ' . $global_city . ', call and speak with the experienced home comfort experts at ComfyFirst today.',
					];
