...
$title = 'Fabric Ductwork / Fabric Ducting';
...
$banner = 'Fabric Ductwork / Fabric Ducting';
							...
							<div class="card-body p-xxl-5 p-4">
								<div class="row">
									<div class="col-xxl-12">
										<p class=" text-dark display-2 line-height-1 fw-bold">Fabric Ductwork / Fabric Ducting</p>
									</div>
								</div>
								<p>When there is talk about ducts, the common thing that comes to mind are massive systems constructed of aluminium, steel or other similar metals. While these are commonly used materials in ducting, there are others as well. We urge consumers to consider all the pros of this material. While fabric may appear to be a delicate and untrustworthy medium for this use, it performs admirably well.</p>
							</div>
						</div>
				...
				<div class="row align-items-center">
					...
					<div class="col-xxl-7">
						<div class="py-3 py-xxl-5">
							<p class="display-2 fw-bold line-height-1 mb-4">What Is Fabric Ductwork in <?= $global_city ?>?</p>
							<hr class="hr-h hr-white ">

							<p>Fabric ductwork is as efficient as ducting made of conventional materials. It comes in a variety of shapes, including complete round, semi-round, and quarter round configurations that distribute conditioned air around your commercial premise</p>

							<p>Fabric is extremely versatile since it can be cut to any size or form, allowing for customised solutions. It ensures that conditioned air is distributed uniformly and without draughts and is constructed with a tough and long-lasting custom-woven cloth. </p>
		...
		<div class="row justify-content-center">
			<div class="col-xxl-9">
				<div class="row align-items-center">
					<div class="col-xxl-6">
						<div class="py-3 py-xxl-5">
							<p class="display-2 fw-bold line-height-1 mb-4 me-xxl-n5">The Advantages of Fabric Ducting</p>
							...
							<p>Fabric ductwork has a number of significant advantages such as:</p>
							<ul>

								<li>It is simple to maintain, since you can just remove and wash it. </li>
								<li>Additionally, this ductwork is excellent for sound insulation. Since the installations absorb and break down sound, making it suitable for recording rooms, studios, and performance arenas.</li>
								<li>These materials don’t shrink, have a higher dust-holding capacity, and do not fade.</li>
								<li>You can select a combination that meets the criteria of your property.</li>
							</ul>
