...
$title = 'Commercial Plumbing | Commercial Plumber ' . $global_city . ' | UpFront Price';
$description = "We are a leading Commercial Plumber " . $global_city . ", providing Commercial Plumbing services. Specialising in sewer blockage, pipe location, leak detection and more.";
$imgfolder = 'gas';

$banner = $global_city . "'s Commercial Plumbing Professionals";
	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-xxl-9">
				...
				<div class="card mb-4 mb-xxl-5 shadow border-0 rounded-0">
					<div class="row g-0">
						<div class="col-xl-4 order-2 order-xl-1">
							<?= lazyImg("$imgfolder/cc34.jpg", randalts($alts), "br w-100 h-100") ?>
						</div>
						<div class="col-xl-8 order-1 order-xl-2">
							<div class="card-body p-xxl-5 p-4">
								<p class=" text-dark display-2 line-height-1 fw-bold"><?= $global_city ?>'s Commercial Plumbing Professionals</p>
								<p>When you need expert commercial or facilities plumbing in <?= $global_city ?>, you can depend on the commercial specialists from PlumbFirst.</p>
							</div>
						</div>
				...
				<p class="h1 line-height-1 text-dark text-center fw-bold mb-5 mt-xxl-5">Already the trusted choice of businesses across the metropolitan area, discover how PlumbFirst can help you today:</p>

				<div class="row">
					<?php $bctas = [
						'COMMERCIAL PLUMBING EXPERTS' => "With experience of commercial plumbing needs, we can help keep your business or facility up and running.",
						'FAST & ON-TIME' => "With fast service from multiple locations across " . $global_city . ", we won't keep you waiting. You can depend on PlumbFirst.",
						...
						'LEAKS AND REPIPES' => "All leak detection and pipe repair needs.",
						'BACKFLOW' => "Including annual backflow preventer testing, repairs and new installations.",
					];
					$i = 0;
				...
				<p class="h4 text-dark mt-3">For great service for all your commercial plumbing needs across <?= $global_city ?>, call and speak with PlumbFirst today.</p>
