							...
							<div class="card-body p-xxl-5 p-4">
								<div class="row">
									<div class="col-xxl-12">
										<p class=" text-dark display-2 line-height-1 fw-bold">Water Cool Units</p>
									</div>
								</div>
								<p>Water cool units are an excellent option if you're searching for an energy-efficient AC to cool your work area or home in a high rise. These systems make use of cutting-edge technologies to provide year-round comfort.</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row align-items-center">
					...
					<div class="col-xxl-7">
						<div class="py-3 py-xxl-5">
							<p class="display-2 fw-bold line-height-1  mb-4">How do <?= $global_city ?> Water Cool Units Work?</p>
							<hr class="hr-h hr-white ">

							<p>Today, high-rise buildings are more common than not, and water cool units provide an excellent cooling solution in these structures. They are available in vertical as well as horizontal configurations. Water flows directly through the condenser coils in them, removing the refrigerant's heat. The heated water is routed through a hose to a separate drain, ensuring that no humidity or water is introduced into the areas being cooled.</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row justify-content-center">
			<div class="col-xxl-9">
				<div class="row align-items-center">
					<div class="col-xxl-6">
						<div class="py-3 py-xxl-5">
							<p class="display-2 fw-bold line-height-1 mb-4 me-xxl-n5">Why Should You Choose Water Cooled Units?</p>
							...
							<p>Numerous reasons exist for utilising water-cooled units, including the following:</p>
							<ul>
								<li>Most leading brands' systems incorporate a water-cooled condenser and an efficient air-cooled evaporator to achieve a level of performance unmatched by an air-cooled unit.</li>
								<li>Available in a variety of capacities, you're sure to find something that meets your needs.</li>
								<li>They are designed to run on independent power sources, which eliminates the need for expensive central plants.</li>
								<li>Due to their unique design and ability to fit into small spaces and niches, they are ideal for high-rise structures that forbid balcony unit installations.</li>
							</ul>
