	...
	<div class="container-fluid text-white position-relative z-1 py-xl-5">
		<div class="row justify-content-center">
			<div class="col-xl-9">
				...
				<p class="font-weight-bold h1 mb-5 pb-5 text-dark">Thank you. Message Sent.</p>
						...
						<div class="col-xxl-6">
							<div class="mb-4">
								...
								<select class="form-select" id="yourservice" name="service" required>
									...
									<?php $options =[ 'Tap Repairs','Toilet Repairs','Shower Repairs','Sink Repairs','Tap Fitting Replacement','Broken Pipes Repair','Blocked Drains','Blocked Sewers','Blocked Storm Water','Blocked Sinks','Blocked Floor Drains','Overflowing Drains','Blocked Toilets','Blocked Main Boundary Shaft','Grease Blockages','Blocked Kitchen Sinks','Blocked Shower Drain','Tree Roots In Pipes','Cracked Sewer Pipes','High Pressure Jet Blasting','Sewer Chokes','CCTV Drain Camera Inspections','Boundary Trap Replacements','Water Leak Detection','Hot Water','Hot Water Repairs','Hot Water Installation','Hot Water Replacement','Hot Water Cost','Hot Water System Brands',]; 
