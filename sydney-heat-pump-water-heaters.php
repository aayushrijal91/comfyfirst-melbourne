...
$title = 'Heat Pump Water Heater Mebourne | Plumber Sydney | PlumbFirst Plumbing';
$description = "If you're looking to reduce your energy costs as well as helping the environment at the same time, then speak with the experts at PlumbFirst about a solar heat pump water heating solution for your";
$imgfolder = 'hotwater';

$banner = "Heat Pump Water Heater Solutions";
	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-xxl-9">
					...
					<div class="row g-0">
						...
						<div class="col-xl-8 order-1 order-xl-2">
							<div class="card-body p-xxl-5 p-4">
								<p class=" text-dark display-2 line-height-1 fw-bold">Heat Pump Water Heater Solutions For Your Sydney Home</p>
								<p>If you're looking to reduce your energy costs as well as helping the environment at the same time, then speak with the experts at PlumbFirst about a solar heat pump water heating solution for your Sydney home. PlumbFirst can guide you through the best heat pump water heating options available and provide an expert installation of your new system and all with a level of service that is second to none. To read more about our satisfaction guaranteed service, click here.</p>
							</div>
						</div>
				...
				<div class="row">
					<?php $bctas=[
						'EXCELLENT ENERGY EFFICIENCY/SAVE ON YOUR ENERGY COSTS'=>"Because the heat pump water heater obtains its energy from the air surrounding it which is heated by the sun (the source of much of the heat), it has a much higher energy efficiency than a conventional electric or gas water heater. 
						<details>
						<summary>Read more</summary>
						<p>The heat pump water heater can produce up to 4 times the hot water energy put in as compared to a traditional electric water heater (that takes more energy in than it can put out). With the continually increasing energy costs there is no better time than now to be looking at ways to reduce your energy consumption. With such a massive potential reduction in your energy consumption compared to an electric water heating option, speak with the experts at PlumbFirst today about your heat pump water heating options.</p>
						</details>
						",
						'ALWAYS HOT WATER WHATEVER THE WEATHER'=>"No matter what the weather, a heat pump water heater has a backup element to heat your water conventionally or 'top up' the temperature to your needs.",
						'EXPERT INSTALLATIONS'=>"To get the most out of your new heat pump water heater it is important to not only have your new system correctly rated and sized for your family, home and budget, but it must be expertly placed and installed. 
						<details>
						<summary>Read more</summary>
						<p>At PlumbFirst, we not only have the experience, we have the knowledge and expertise to ensure your new solar heat pump water heater is placed in the optimum position and expertly installed to ensure you get the most out of your new water heating system for the longest possible lifetime.</p>
						</details>

						",
						'BEST BRANDS AND WARRANTIES'=>"We will guide you through all the leading brands and their features with the best possible warranties for your complete peace of mind.",
						'ENVIRONMENTALLY FRIENDLY'=>"Because the solar heat pump water heater uses the sun for its energy, you are not only lowering your energy costs, but by reducing your energy consumption, you are reducing your carbon footprint - and every little bit helps the environment for the future.",
						'SATISFACTION GUARANTEED SERVICE'=>"We pride ourselves on providing our customers with the highest level of service that they deserve, and we're so confident you'll be happy with the level of service you receive, we guarantee it.",
					]; 
					$i=0;
				...
				<p class="h4 text-dark mt-3">For all your solar heat pump water heater installations, repairs and maintenance, call and speak with the heat pump experts at PlumbFirst today.</p>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-xxl-9">
				...
				<p class="h5 mb-5">When you choose PlumbFirst for your plumbing, hot water and drain needs across Sydney, you can be sure that our high quality, friendly service is second-to-none. Discover the PlumbFirst difference for yourself, or read from our other happy customers here.</p>
				...
				<div class="row">
					<?php $ser=[
						...
						'FASTER SERVICE'=>"Because PlumbFirst operates from MULTIPLE locations right across the Sydney metropolitan area, you can benefit from a rapid response for your plumbing needs.",
