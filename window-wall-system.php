...
$banner = 'Window Wall<br>AC System';
							...
							<div class="card-body p-xxl-5 p-4">
								<div class="row">
									<div class="col-xxl-12">
										<p class=" text-dark display-2 line-height-1 fw-bold">How Does A <?= $global_city ?> Window Wall System Work?</p>
									</div>
								</div>
								<p>This system is completely contained within a sturdy cabinet. It is typically mounted in wall/window openings, and distributes comfortable air to various indoor spaces. Its condenser exhausts warm air into the exterior atmosphere. When configured as a reverse cycle unit, these devices will provide both hot and cold air. Different leading brands offer window wall air conditioners with capacities ranging from 1.6Kw to 6Kw.</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row align-items-center">
					...
					<div class="col-xxl-7">
						<div class="py-3 py-xxl-5">
							<p class="display-2 fw-bold line-height-1 mb-4"><?= $title ?></p>
							<hr class="hr-h hr-white ">

							<p>A Window Wall System AC is a discreet and silent way to provide comfortable, clean air to areas of reasonable size in homes and offices.</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row justify-content-center">
			<div class="col-xxl-9">
				<div class="row align-items-center">
					<div class="col-xxl-6">
						<div class="py-3 py-xxl-5">
							<p class="display-2 fw-bold line-height-1 mb-4 me-xxl-n5">The Advantages of Using a Window Wall System</p>
							...
							<p>Choosing these units has numerous advantages, including:</p>
							<ul>
								<li>The majority of models (with the exception of the smaller capacity models) include multi-speed fans and remotely controlled functions for added comfort and convenience.</li>
								<li>Additionally, the units dehumidify the indoor air by mixing recycled and fresh air to increase comfort.</li>
								<li>The system would include electronic controls on the fascia panel of the unit.</li>
