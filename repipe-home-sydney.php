...
$title = 'Leak & Pipe Repair ' . $global_city . ' | Burst Pipe Repair ' . $global_city;
$description = "Burst Pipe Repair " . $global_city . " specialists. We're experts in leak detection and pipe repairs. Call us now on 1300 775 634 for repair leaking pipes in " . $global_city . ".";
$imgfolder = 'gas';

$banner = "The Leak & Pipe Repair Specialists in " . $global_city;
	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-xxl-9">
				...
				<div class="card mb-4 mb-xxl-5 shadow border-0 rounded-0">
					<div class="row g-0">
						<div class="col-xl-4 order-2 order-xl-1">
							<?= lazyImg("$imgfolder/cc21.jpg", randalts($alts), "br w-100 h-100") ?>
						</div>
						<div class="col-xl-8 order-1 order-xl-2">
							<div class="card-body p-xxl-5 p-4">
								<p class=" text-dark display-2 line-height-1 fw-bold">The Leak & Pipe Repair Specialists in <?= $global_city ?></p>
								<p>For expert plumbing leak detection and pipe repairs across <?= $global_city ?>, you can count on the satisfaction guaranteed service and pipe leak expertise you receive from PlumbFirst. </p>
							</div>
						</div>
				...
				<div class="row">
					<?php $bctas = [
						'ON-TIME LEAK DETECTION' => "We have the technology to find any leak, even underground, under floors or behind walls. PlumbFirst will be there on-time, 24 hours, 7 days.",
						'PIPE REPAIRS' => "If you have an issue with any of your pipes, we can perform a full professional repair.",
						'PRICING BY THE JOB, NOT THE HOUR' => "With PlumbFirst you know the full price for the entire job before you give us the go-ahead.",
						'COPPER REPIPES' => "If you are having issues with older pipes experiencing problems such as leaks, intermittent water pressure, or rusty-tasting or looking water then an upgrade of your home's pipes to modern standards can greatly improve your home's plumbing system.",
						'LOUD PIPES' => "If you have loud pipes that emit a 'shudder' when you turn them on and off, then PlumbFirst can help solve your issue.",
						'WATER PRESSURE PROBLEMS' => "PlumbFirst can help control or alter your home's water pressure to meet your needs.",
						'SATISFACTION GUARANTEED SERVICE' => "Above all else be sure of satisfaction guaranteed service from polite and presentable plumbers.",
					];
					$i = 0;
							...
							<div class="card rounded-0 border-0 h-100">
								...
								<div class="card-body h-100">
									<div class="row mb-3 align-items-center">
										...
										<div class="col">
											<p class="mb-0 h3 line-height-1 fw-bold text-dark"><i><?= $key ?></i></p>
										</div>
									</div>
				...
				<p class="h4 text-dark mt-3">For all your leak detection and pipe repair needs across <?= $global_city ?>, call and speak with the experts at PlumbFirst today.</p>
			</div>
		</div>
	</div>
</section>
