...
$title = 'Stair Pressurisation Systems';
...
$banner = 'Stair Pressurisation Systems';
							...
							<div class="card-body p-xxl-5 p-4">
								<div class="row">
									<div class="col-xxl-12">
										<p class=" text-dark display-2 line-height-1 fw-bold">Stair Pressurisation Systems</p>
									</div>
								</div>
								<p>Many people wonder what stair pressurisation systems are and whether they are necessary. These installations can significantly increase your property’s safety levels in case of a fire on the premises.</p>
							</div>
						</div>
				...
				<div class="row align-items-center">
					...
					<div class="col-xxl-7">
						<div class="py-3 py-xxl-5">
							...
							<p>When there is a rise in the pressure levels in a stairwell, people may find it difficult to open their doors and get out of their homes or commercial spaces. However, when there is a stair pressurisation system installed, it automatically reduces this pressure, allowing people to get out and escape in time. This can potentially save lives. The different types of systems you can install include:</p>

							<ul>

								<li>Automatic window opening devices</li>
								<li>Sub-ducts connected to various exhaust & ventilation units </li>
		...
		<div class="row justify-content-center">
			<div class="col-xxl-9">
				<div class="row align-items-center">
					<div class="col-xxl-6">
						<div class="py-3 py-xxl-5">
							<p class="display-2 fw-bold line-height-1 mb-4 me-xxl-n5">Commercial-Quality Air Pressurization System Installations </p>
							...
							<p>These features are effective in reducing the pressure levels in staircase areas. We are an experienced and licensed company offering the best services to our clients. Our company provides the perfect balance of quality and affordability. Since there are many different types of systems on the market, making the right choice isn’t easy. It’s where our expertise comes in.</p>
