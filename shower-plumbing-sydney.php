...
$title = 'Shower Plumbing ' . $global_city . ' | Shower Leaks & Repairs';
$description = "Shower Plumbing specialists in " . $global_city . ". Affordable Shower Leaks and Repair services. We fix all types of bathroom showers of all brands & sizes. Call Now";
$imgfolder = 'gas';

$banner = "Expert Bath and Shower Plumbing Across " . $global_city;
	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-xxl-9">
				...
				<div class="card mb-4 mb-xxl-5 shadow border-0 rounded-0">
					<div class="row g-0">
						<div class="col-xl-4 order-2 order-xl-1">
							<?= lazyImg("$imgfolder/cc32.jpg", randalts($alts), "br w-100 h-100") ?>
						</div>
						<div class="col-xl-8 order-1 order-xl-2">
							<div class="card-body p-xxl-5 p-4">
								<p class=" text-dark display-2 line-height-1 fw-bold">Expert Bath and Shower Plumbing Across <?= $global_city ?></p>
								<p>For the best in shower and bath plumbing across <?= $global_city ?>, you can count on the great service you receive from PlumbFirst (read more here).</p>
							</div>
						</div>
				...
				<div class="row">
					<?php $bctas = [
						'NEW SHOWER INSTALLATIONS' => "Including the latest shower designs and taps, all professionally installed, and backed up by a written guarantee.",
						'SHOWER LEAKS & REPAIRS' => "Including faulty showers and shower leaks.",
						'BLOCKED SHOWER, FLOOR AND BATH DRAINS' => "Experts at clearing all drain blockages.",
						'NEW BATH INSTALLATIONS' => "With the best in bath design for the ultimate in relaxation. PlumbFirst can help show you the best in modern baths, bring the new bath to your door, install it, and even take the old bath away.",
						'WATER SAVING SOLUTIONS' => "Save with water-saving shower solutions.",
						'ACCESSIBILITY SHOWERS' => "For easy access for bathing.",
					];
					$i = 0;
				...
				<p class="h4 text-dark mt-3">For all of your bath and sink plumbing needs in <?= $global_city ?>, call and speak with the specialists at PlumbFirst today.</p>
