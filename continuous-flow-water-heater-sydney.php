...
$title = 'Continuous Flow Water Heater ' . $global_city . ' | Plumber ' . $global_city . ' | PlumbFirst Plumbing';
$description = "Enjoy an 'endless' supply of hot water for your " . $global_city . " home and imagine never running out of hot water again - no more cold showers! With a continuous flow water heater installation from";
$imgfolder = 'hotwater';

$banner = "Continuous Flow Water Heater Professionals";
	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-xxl-9">
				...
				<div class="card mb-4 mb-xxl-5 shadow border-0 rounded-0">
					<div class="row g-0">
						<div class="col-xl-4 order-2 order-xl-1">
							<?= lazyImg("$imgfolder/cc3.jpg", randalts($alts), "br w-100 h-100") ?>
						</div>
						<div class="col-xl-8 order-1 order-xl-2">
							<div class="card-body p-xxl-5 p-4">
								<p class=" text-dark display-2 line-height-1 fw-bold"><?= $global_city ?>'s Continuous Flow Water Heater Professionals</p>
								<p>Enjoy an 'endless' supply of hot water for your <?= $global_city ?> home and imagine never running out of hot water again - no more cold showers! With a continuous flow water heater installation from PlumbFirst, you could be enjoying 'endless' hot water today and all with a level of service that is second to none.</p>
							</div>
						</div>
				...
				<p class="h1 line-height-1 text-dark text-center fw-bold mb-5 mt-xxl-5">Discover how PlumbFirst can have you enjoying the latest water heating technology in your home today:</p>

				<div class="row">
					<?php $bctas = [
						'NEVER RUN OUT OF HOT WATER' => "Relax in the knowledge you'll never have an unexpected cold shower in your home again when you choose the latest in hot water technology with a continuous flow water heater. Conventional water heaters use a tank to store your hot water and once that tank has been emptied, you then have to wait for the tank to be refilled and the new water heated. With a continuous flow water heating solution, there is no tank, only hot water that is heated instantly as and when you require it - an 'endless' supply of hot water at your command.",
						'SAVE ON ENERGY BILLS' => "Because the continuous flow water heater no longer has to heat and reheat water in a tank like the conventional water heater, you no longer have to waste precious energy and money heating water unnecessarily - reducing both your energy consumption and your energy costs for equivalent usage.",
						'EXPERT INSTALLATION' => "To ensure you get the most out of your new continuous flow water heater, you not only need to have it correctly sized and rated for your home, family and lifestyle, but it is imperative to have it expertly installed. PlumbFirst have the expertise and experience to ensure you get the right system, expertly placed and installed so you can enjoy trouble free 'endless' hot water for as long as possible.",
						'FREE UP SPACE' => "With space at a premium these days, why waste it on a water tank when you can have a 'tankless' continuous flow water heating solution from PlumbFirst.",
						'LEADING BRANDS/BEST WARRANTIES' => "We can show you all the leading continuous flow water heating systems with the best warranties for your peace of mind.",
						'ENVIRONMENTALLY FRIENDLY' => "With so much concern about the planet these days, every little bit helps. With the lower energy consumption of a continuous flow water heater, you could be lowering your carbon footprint.",
						'SATISFACTION GUARANTEED SERVICE' => "We're so confident you'll be happy with the PlumbFirst level of service, we guarantee it! You can read more about our customer service guarantee here.",
					];
					$i = 0;
				...
				<p class="h4 text-dark mt-3">For all your 'endless' hot water installations, repairs and maintenance, call and speak with the experts at PlumbFirst today.</p>
			</div>
		</div>
	</div>
</section>
