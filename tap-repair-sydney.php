...
$title = 'Leaking Tap Repairs ' . $global_city . ' |  Stop Tap Leaks Just $70';
$description = "Get your Leaking Taps Repair and fixed now at competitive prices.! We provide all types of Leaking Tap Repair & Replacement " . $global_city . " wide.";
$imgfolder = 'gas';

$banner = "Fast Tap Repairs and Sink Plumbing";
	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-xxl-9">
				...
				<div class="card mb-4 mb-xxl-5 shadow border-0 rounded-0">
					<div class="row g-0">
						<div class="col-xl-4 order-2 order-xl-1">
							<?= lazyImg("$imgfolder/cc33.jpg", randalts($alts), "br w-100 h-100") ?>
						</div>
						<div class="col-xl-8 order-1 order-xl-2">
							<div class="card-body p-xxl-5 p-4">
								<p class=" text-dark display-2 line-height-1 fw-bold">Fast Tap Repairs and Sink Plumbing across <?= $global_city ?></p>
								<p>When it comes to great plumbers for all of your tap or sink plumbing needs across <?= $global_city ?>, you can count on the great service you receive from PlumbFirst (read more here). </p>
							</div>
						</div>
				...
				<p class="h1 line-height-1 text-dark text-center fw-bold mb-5 mt-xxl-5">PlumbFirst can help you with all of your plumbing needs including:</p>

				<div class="row">
					<?php $bctas = [
						'NEW TAP INSTALLATIONS' => "Including the latest shower designs and taps, all professionally installed, and backed up by a written guarantee.",
						'TAP REPAIRS' => "From leaking taps to issues caused by corrosion, PlumbFirst can assist with same day repairs for all your tap repair needs.",
						'BLOCKED SINK DRAINS' => "Have a blocked sink? PlumbFirst has the answer, and our plumber can be direct to your door from multiple locations.",
						'NEW SINK INSTALLATIONS' => "PlumbFirst can again assist with the very latest in designs for your new sink or vanity unity, or bathroom renovation.",
						'ACCESSIBILITY TAPS' => "For customers with accessibility needs, easier-turning taps can be a tremendous improvement to daily quality of life, and are a simple upgrade to any home.",
					];
					$i = 0;
				...
				<p class="h4 text-dark mt-3">For all of your tap and sink plumbing needs in <?= $global_city ?>, call and speak with the specialists at PlumbFirst today.</p>
